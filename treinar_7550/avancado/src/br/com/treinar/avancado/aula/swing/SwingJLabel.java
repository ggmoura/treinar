...
public class SwingJLabel {
	...
	private void prepareGUI() {
		...
		WindowAdapterImpl mz = new WindowAdapterImpl();
		
		mainFrame.addWindowListener(mz);

		mainFrame.addWindowStateListener(new WindowStateListener() {
			public void windowStateChanged(WindowEvent evend) {
				JOptionPane.showMessageDialog(mainFrame, "mz");
			}
		});
